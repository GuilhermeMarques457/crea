...
[Authorize]
public class ObrasController(IObraRepository obraRepository, IProfissionalRepository profissionalRepository) : ControllerBase
{
    [HttpGet]
    ...
    public async Task<IActionResult> Update(Guid id, [FromBody] CreateObraDto dto)
    {
        ...
        obra.Cep = dto.Cep;
        obra.Proprietario = dto.Proprietario;
        obra.TelefoneProprietario = dto.TelefoneProprietario;
    ...
    private static ObraDto ToDto(Obra o) => new()
    {
        ...
        TelefoneProprietario = o.TelefoneProprietario,
        Empresa = o.Empresa,
