    ...
    IAssinaturaRepository assinaturaRepository) : ControllerBase
{
    ...
    private async Task<TermoConclusaoDto> ToDtoAsync(TermoConclusao t)
    {
        ...
        return new TermoConclusaoDto
        {
            ...
            ProfissionalId = t.Obra?.ProfissionalId ?? Guid.Empty,
            NomeProfissional = t.Obra?.Profissional?.Nome ?? string.Empty,
            NumeroRegistro = t.Obra?.Profissional?.NumeroRegistro ?? string.Empty,
            CriadoEm = t.CriadoEm,
