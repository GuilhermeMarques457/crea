...
import { PosicaoObra, POSICAO_OBRA_LABELS, TipoUsuario } from '../../../shared/models/api.models';
...
export class RegistroDiarioFormComponent implements OnInit {
  ...
  isResponsavel = computed(() => {
    ...
    return tipo === TipoUsuario.ResponsavelTecnico || tipo === TipoUsuario.Admin;
  });
  ...
  submit() {
    ...
    const dto = {
      ...
      imagemAssinaturaResponsavel: this.imagemAssinaturaResponsavel() ?? undefined,
    };
    const onOk = () => {
